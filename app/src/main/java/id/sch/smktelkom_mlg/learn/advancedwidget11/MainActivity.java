package id.sch.smktelkom_mlg.learn.advancedwidget11;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void doProses(LinearLayout llMain) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if(!nama.isEmpty()) hasil+= "Anak ke " + (i+1) + " : " + nama + " berumur " + umur + " tahun \n";
        }
    ...
    private void addEditText(LinearLayout llMain) {
        ...
        for(int i=1; i <=5; i++) {
            ...
            etNama.setHint("Masukkan nama anak ke " + i);

            final EditText etUmur = new EditText(this);
            llMain.addView(etUmur);
            etUmur.setHint("Masukkan umur anak ke " + i);
